...
void test_wallet() {
    Byte pubkey[33] = {
        0x02,0x50,0x86,0x3a,0xd6,0x4a,0x87,0xae,0x8a,0x2f,0xe8,0x3c,0x1a,0xf1,0xa8,0x40,0x3c,0xb5,0x3f,0x53,0xe4,0x86,0xd8,0x51,0x1d,0xad,0x8a,0x04,0x88,0x7e,0x5b,0x23,0x52
        // 0x80,0x0C,0x28,0xFC,0xA3,0x86,0xC7,0xA2,0x27,0x60,0x0B,0x2F,0xE5,0x0B,0x7C,0xAE,0x11,0xEC,0x86,0xD3,0xBF,0x1F,0xBE,0x47,0x1B,0xE8,0x98,0x27,0xE1,0x9D,0x72,0xAA,0x1D
    };
    char address[100] = {0};
    private_key_to_wip(pubkey, address);
    printf("address = %s\n", address);
}
